...
def make_deeplab(pretrained, num_classes=21, freeze_bn=False):
    net = resnet101(pretrained=pretrained, num_classes=num_classes, num_groups=None, weight_std=False, beta=False)
    net.train()
    if freeze_bn:
...
if __name__ == '__main__':
    net = resnet101(pretrained=True, num_classes=21, num_groups=None, weight_std=False, beta=False)
    # print(net)
