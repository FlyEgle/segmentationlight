...
class FCNResNet50_8S(nn.Module):
    def __init__(self, num_classes=21, pretrained=True):
        super(FCNResNet50_8S, self).__init__()
        self.backbone = resnet50(pretrained=pretrained)

        self.NUM_CLASSES = num_classes
        self.smooth_conv1 = nn.Conv2d(2048, 1024, 3, 1, 1)
        self.relu1 = nn.ReLU(inplace=True)
        self.bn1 = nn.BatchNorm2d(1024)
        self.smooth_conv2 = nn.Conv2d(1024, 512, 3, 1, 1)
        self.relu2 = nn.ReLU(inplace=True)
        self.bn2 = nn.BatchNorm2d(512)

        self.smooth = nn.Conv2d(512, 512, 3, 1, 1)
        self.relu3 = nn.ReLU(inplace=True)
        self.bn3 = nn.BatchNorm2d(512)

        self.classification = nn.Conv2d(512, self.NUM_CLASSES, 1, 1, 0)
...
class FCNResNet101_8S(nn.Module):
    def __init__(self, num_classes=21, pretrained=True):
        super(FCNResNet101_8S, self).__init__()
...
class FCNResNet152_8S(nn.Module):
    def __init__(self, num_classes=21, pretrained=True):
        super(FCNResNet152_8S, self).__init__()
